...
$f5mgmt = [PSCustomObject]@{
    snetname = "sn-pf2-aue-f5-mgmt"
    rtname   = "rt-sn-pf2-aue-f5-mgmt"
    nsgname  = "nsg-sn-pe2-aue-f5-mgmt"
    CIDR     = "10.98.42.128/28"
}

$f5bcked_web = [PSCustomObject]@{
    snetname ="sn-pf2-aue-lb-backend_web"
    rtname   = "rt-sn-pf2-aue-lb-backend_web"
    nsgname  = "nsg-sn-pe2-aue-lb-backend_web"
    CIDR     = "10.98.42.144/28"
    
}

$f5bcked_app = [PSCustomObject]@{
    snetname = "sn-pf2-aue-lb-backend_app"
    rtname   = "rt-sn-pf2-aue-lb-backend_app"
    nsgname  = "nsg-sn-pe2-aue-lb-backend_app"
    CIDR     = "10.98.42.160/28"
    
}

$f5externalvirtualsvrs = [PSCustomObject]@{
    snetname = "sn-pf2-aue-lb-external"
    rtname   = "rt-sn-pf2-aue-lb-external"
    nsgname  = "nsg-sn-pf2-aue-lb-external"
    CIDR     = "10.98.43.0/25"
}

$f5internalvirtualsvrs = [PSCustomObject]@{
    snetname = "sn-pf2-aue-lb-internal"
    rtname   = "rt-sn-pf2-aue-lb-internal"
    nsgname  = "nsg-sn-pf2-aue-lb-internal"
    CIDR     = "10.98.44.0/24"
...
$HUBVNET    = Get-AzVirtualNetwork -Name "vnet-npp-con-hub-aue-001" -ResourceGroupName "rg-dxg"
$NetappVnet = Get-AzVirtualNetwork -Name "vnet-npp-mgt-aue-002" -ResourceGroupName "rg-dxg"
...
if($notP)
{
    ...
    #$nwrg = New-AzResourceGroup -Name $MGTRGName  -Location $mgtlocation
...
$subnetConfig = Add-AzVirtualNetworkSubnetConfig @subnet | Out-Null
$mgtvirtualNetwork | Set-AzVirtualNetwork | Out-Null
