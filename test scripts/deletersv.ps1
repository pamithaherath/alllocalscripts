...
$VaultName = "rcv-prd-ide-ads-backup-auc1" #fetch automatically
$Subscription = "NIPD-Identity" #fetch automatically
$ResourceGroup = "rg-prd-ide-ad-auc1" #fetch automatically
$SubscriptionId = "4fa70f20-22f6-48fe-b26b-a837f5653be8" #fetch automatically
