...
$NSG1 | Add-AzNetworkSecurityRuleConfig -Name "Allow-Tenable-Traffic-Between-Subnets" -Access Allow `
                        -Protocol * -Direction Inbound -Priority 2000 -SourceAddressPrefix "10.98.17.96/27" -SourcePortRange * `
                        -DestinationAddressPrefix "10.98.17.96/27" -DestinationPortRange *
                        $NSG1 | Set-AzNetworkSecurityGroup
