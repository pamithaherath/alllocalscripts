...
$inFile1 = Import-Csv "C:\Users\pherathmudiy\OneDrive - DXC Production\ADHA\Change Requests\Modify NSG rules prod management\AUE\oem.csv"
$inFile2 = Import-Csv "C:\Users\pherathmudiy\OneDrive - DXC Production\ADHA\Change Requests\Modify NSG rules prod management\AUE\oemudp.csv"
...
$NSG1 = Get-AzNetworkSecurityGroup -Name "nsg-sn-npp-aue-mgt-oem" -ResourceGroupName "rg-npp-mgt-network-aue-001"  
