...
$NSG1 = Get-AzNetworkSecurityGroup -Name "nsg-sn-prd-ase-mgt-tenable" -ResourceGroupName "rg-prd-mgt-network-ase"  
...
$NSG1 | Add-AzNetworkSecurityRuleConfig -Name "Allow-Tenable-Traffic-Between-Subnets" -Access Allow `
                        -Protocol * -Direction Inbound -Priority 2000 -SourceAddressPrefix "10.103.17.160/27" -SourcePortRange * `
                        -DestinationAddressPrefix "10.103.17.160/27" -DestinationPortRange *
                        $NSG1 | Set-AzNetworkSecurityGroup
