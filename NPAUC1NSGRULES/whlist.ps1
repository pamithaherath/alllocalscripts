...
$inFile1 = Import-Csv "C:\Users\pherathmudiy\OneDrive - DXC Production\ADHA\Change Requests\Modify NSG rules non-prod management\AUC1\whlist.csv"
$inFile2 = Import-Csv "C:\Users\pherathmudiy\OneDrive - DXC Production\ADHA\Change Requests\Modify NSG rules non-prod management\AUC1\whlistudp.csv"
...
$NSG1 = Get-AzNetworkSecurityGroup -Name "nsg-sn-npp-auc1-mgt-whlist" -ResourceGroupName "rg-npp-mgt-network-auc1-001"  
