...
$inFile1 = Import-Csv "C:\Users\pherathmudiy\OneDrive - DXC Production\ADHA\Change Requests\Modify NSG rules non-prod management\cyberark.csv"
$inFile2 = Import-Csv "C:\Users\pherathmudiy\OneDrive - DXC Production\ADHA\Change Requests\Modify NSG rules non-prod management\cyberarkudp.csv"



        $destinationport = $inFile1.DestPort_d
        $Udestinationport = $inFile2.UDestPort_d
     
       
$NSG1 = Get-AzNetworkSecurityGroup -Name "nsg-sn-npp-aue-mgt-cyberark" -ResourceGroupName "rg-npp-mgt-network-aue-001"  
