...
$inFile1 = Import-Csv "C:\Users\pherathmudiy\OneDrive - DXC Production\ADHA\Change Requests\Modify NSG rules non-prod management\siemsit.csv"
$inFile2 = Import-Csv "C:\Users\pherathmudiy\OneDrive - DXC Production\ADHA\Change Requests\Modify NSG rules non-prod management\siemsitudp.csv"
...
$NSG1 = Get-AzNetworkSecurityGroup -Name "nsg-sn-npp-aue-mgt-siemsit" -ResourceGroupName "rg-npp-mgt-network-aue-001"  
